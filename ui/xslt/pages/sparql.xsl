	...
	<xsl:template match="/">
		<html lang="en">
			<head>
				...
				<script type="text/javascript" src="{$display_path}kerameikos-assets/javascript/codemirror.js"/>
				<script type="text/javascript" src="{$display_path}kerameikos-assets/javascript/matchbrackets.js"/>
				<script type="text/javascript" src="{$display_path}kerameikos-assets/javascript/sparql.js"/>
				<script type="text/javascript" src="{$display_path}kerameikos-assets/javascript/sparql_functions.js"/>
				<link rel="stylesheet" href="{$display_path}kerameikos-assets/css/codemirror.css"/>
