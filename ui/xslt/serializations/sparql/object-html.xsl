...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
	xmlns:dbpedia-owl="http://dbpedia.org/ontology/" xmlns:skos="http://www.w3.org/2004/02/skos/core#" xmlns:crm="http://www.cidoc-crm.org/cidoc-crm/" xmlns:crmsci="http://www.ics.forth.gr/isl/CRMsci/"
	...
	<xsl:variable name="hasGeo" as="xs:boolean"
		select="(//crm:E12_Production[child::crm:P7_took_place_at] or //*[rdf:type/@rdf:resource = 'http://www.cidoc-crm.org/cidoc-crm/E12_Production'][child::crm:P7_took_place_at])"/>
		...
		<html lang="en">
			<head>
				...
				<xsl:if test="descendant::crm:P129i_is_subject_of">
					...
					<script type="text/javascript" src="{$display_path}ui/javascript/display_mirador_functions.js"/>
				</xsl:if>
			</head>
			<body>
	...
	<xsl:template match="crm:P108i_was_produced_by | crm:P4_has_time-span | crm:P43_has_dimension">
		<xsl:choose>
			<xsl:when test="child::*">
