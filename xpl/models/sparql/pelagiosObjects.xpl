...
<!--
	Author: Ethan Gruber
	Date: August 2019
	Function: Get 5000 results per page for vases in the SPARQL endpoint, to be serialized into Pelagios-compliant RDF
-->
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline" xmlns:oxf="http://www.orbeon.com/oxf/processors">
	...
	<p:processor name="oxf:url-generator">
		<p:input name="config">
			<config>
				<url>oxf:/apps/kerameikos/ui/sparql/pelagiosObjects.sparql</url>
