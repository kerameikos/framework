...
<!--
	...
	Function: execute a SPARQL query to extract a list of IDs associated with a kerameikos editor
-->
	...
	<p:processor name="oxf:unsafe-xslt">
		...
		<p:input name="config">
			<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
				...
				<xsl:variable name="service" select="concat($sparql_endpoint, '?query=', encode-for-uri(replace(replace($query, '%URI%', $uri), '%LIMIT%', 'LIMIT 25')), '&amp;output=xml')"/>
